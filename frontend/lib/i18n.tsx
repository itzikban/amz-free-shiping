...
const dictionaries = {
  en: {
    ...
    home_badge_checking: "checking",
    home_badge_free_shipping: "free shipping",
    home_badge_paid_shipping: "paid shipping",
    home_badge_unavailable: "unavailable",
    home_validation_url_invalid: "Please enter a valid URL",
    home_validation_url_protocol: "URL must start with http:// or https://",
    home_validation_url_amazon: "Please use a valid Amazon product URL",
    home_validation_zip_required: "ZIP code is required for US",
    home_validation_zip_format: "Use ZIP format 12345 or 12345-6789",
    home_error_missing_url: "Please provide a product URL",
    home_error_upstream: "Amazon is temporarily unavailable. Try again in a moment.",
    home_error_network: "Network issue while checking product. Please retry.",
    home_error_generic: "Could not complete check. Please try again.",
    home_availability: "Availability",
    home_availability_available: "available",
    home_availability_unavailable: "unavailable",
    home_shipping_cost: "Shipping",
    home_shipping_cost_free: "free",
    home_shipping_cost_unknown: "paid/unknown",
    home_value_na: "N/A",
    ...
    common_yes: "Yes",
    common_no: "No",
    admin_title: "Admin Operations",
    admin_subtitle: "Backend metrics and operation actions.",
    admin_metrics_snapshot: "Metrics snapshot",
    admin_failed_load_metrics: "Failed to load metrics",
    admin_network_load_metrics: "Network error while loading metrics",
    admin_login_username: "Admin username",
    admin_login_password: "Admin password",
    admin_login_cta: "Login",
    admin_logging_in: "Logging in...",
    admin_loading: "Loading...",
    admin_monitors_total: "Monitors total",
    admin_monitors_running: "Monitors running",
    admin_monitors_stopped: "Monitors stopped",
    admin_monitor_notifications: "Monitor notifications",
    admin_user_tracked_items: "User tracked items",
    admin_user_alerts: "User alerts",
    admin_generated: "Generated",
    admin_actions: "Actions",
    admin_replay_failed_jobs: "Replay failed jobs",
    admin_retry_failed_notifications: "Retry failed notifications",
    admin_action_completed: "Action completed",
    admin_network_action_error: "Network or parse error while running action",
    admin_result_prefix: "Result",
  },
  he: {
    nav_checker: "בודק",
    ...
    home_badge_checking: "בודק",
    home_badge_free_shipping: "משלוח חינם",
    home_badge_paid_shipping: "משלוח בתשלום",
    home_badge_unavailable: "לא זמין",
    home_validation_url_invalid: "נא להזין כתובת URL תקינה",
    home_validation_url_protocol: "הקישור חייב להתחיל ב-http:// או https://",
    home_validation_url_amazon: "נא להזין קישור מוצר אמזון תקין",
    home_validation_zip_required: "מיקוד חובה ליעד ארה״ב",
    home_validation_zip_format: "פורמט מיקוד: 12345 או 12345-6789",
    home_error_missing_url: "נא להוסיף קישור מוצר",
    home_error_upstream: "אמזון לא זמין כרגע. נסה שוב בעוד רגע.",
    home_error_network: "בעיית רשת בזמן בדיקת המוצר. נסה שוב.",
    home_error_generic: "לא ניתן להשלים את הבדיקה כרגע.",
    home_availability: "זמינות",
    home_availability_available: "זמין",
    home_availability_unavailable: "לא זמין",
    home_shipping_cost: "משלוח",
    home_shipping_cost_free: "חינם",
    home_shipping_cost_unknown: "בתשלום/לא ידוע",
    home_value_na: "לא זמין",
    country_label: "מדינה",
    ...
    common_yes: "כן",
    common_no: "לא",
    admin_title: "תפעול אדמין",
    admin_subtitle: "מדדי שרת ופעולות תפעול.",
    admin_metrics_snapshot: "צילום מצב מדדים",
    admin_failed_load_metrics: "נכשל בטעינת מדדים",
    admin_network_load_metrics: "שגיאת רשת בעת טעינת מדדים",
    admin_login_username: "שם משתמש אדמין",
    admin_login_password: "סיסמת אדמין",
    admin_login_cta: "התחבר",
    admin_logging_in: "מתחבר...",
    admin_loading: "טוען...",
    admin_monitors_total: "סה״כ מוניטורים",
    admin_monitors_running: "מוניטורים פעילים",
    admin_monitors_stopped: "מוניטורים עצורים",
    admin_monitor_notifications: "התראות מוניטור",
    admin_user_tracked_items: "פריטים במעקב משתמשים",
    admin_user_alerts: "התראות משתמשים",
    admin_generated: "נוצר",
    admin_actions: "פעולות",
    admin_replay_failed_jobs: "הפעל מחדש משימות שנכשלו",
    admin_retry_failed_notifications: "נסה שוב התראות שנכשלו",
    admin_action_completed: "הפעולה הושלמה",
    admin_network_action_error: "שגיאת רשת/פענוח בזמן פעולה",
    admin_result_prefix: "תוצאה",
  },
} as const;
