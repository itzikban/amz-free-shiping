...
const dictionaries = {
  en: {
    ...
    home_discover_title: "Does Amazon Ship Free to You?",
    home_url_placeholder: "Paste any Amazon product link...",
    home_country_il: "Israel (IL)",
    home_country_us: "United States (US)",
    home_zip_placeholder: "ZIP",
    home_analyze: "Check for free shipping",
    home_target_analysis: "Result",
    home_alert_cta_disabled: "Coming soon",
    home_coming_soon_short: "Coming soon",
    home_flow_hint: "Track it — we'll let you know when free shipping comes back.",
    ...
    add_button: "Track this product",
    watchlist_added: "Tracked!",
    notify_me_cta: "Notify me when it ships free",
    loading: "Loading…",
